...
namespace {
    ...
    class Schema.sql extends \Illuminate\Support\Facades\Schema{
         ...
         */
        public
        static function hasTable($table)
        {
         ...
         */
        public
        static function getColumnListing($table)
        {
         ...
         */
        public
        static function hasColumn($table, $column)
        {
         ...
         */
        public
        static function getColumnType($table, $column)
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
         ...
         */
        public
        static function table($table, $callback)
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
         ...
         */
        public
        static function blueprintResolver($resolver)
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
